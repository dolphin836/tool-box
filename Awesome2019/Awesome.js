document.addEventListener('DOMContentLoaded', () => {
    ...
    function addGroupSite(site) {
        ...
        for (let i = 0; i < group.length; i++) {
            ...
            let word = site.word !== undefined ? site.word : '';

            let html = '<div class="card"><div class="card-content"><div class="columns is-mobile is-vcentered" style="margin-bottom: 0;"><div class="column is-narrow"><figure class="image is-32x32"><img class="is-rounded" src="http://chuangzaoshi.com/assets/images/D/pinterest.png"></figure></div><div class="column is-paddingless"><h1 class="title is-6" title="' + site.href + '"><a href="' + site.href + '" class="has-text-dark" target="_blank">' + site.name + '</a></h1></div></div><h2 class="subtitle is-7 has-text-grey">' + word + '</h2><p class="control has-text-grey" title="收藏"><span class="icon is-small"><i class="far fa-star"></i></span></p></div></div>';
